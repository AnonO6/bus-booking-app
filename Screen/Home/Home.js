  ...
  return (
    <View style={{flex: 1}}>
      <SimpleContainer
        ...
        BottomLeftText={person.Name}
        bottomRightLink={() => LoginStateHandler('Logout')}
        ...
        <ScrollView style={{flex: 1}}>
          ...
          <View style={styles.menueContinerStyle}>
            <HomeButtom
              onPress={() =>
                navigation.navigate('BookingDestinationScreen', {person})
              }
              iconName="ios-lock"
              title="Book Seat">
            ...
            <HomeButtom
              onPress={() =>
                navigation.navigate('BookingPendingScreen', {person})
              }
              iconName="ios-lock"
              title="My Booking">
              <View style={{marginLeft: 'auto', marginRight: 'auto'}}>
          ...
          <View
            ...
            <View style={styles.menueContinerStyle}>
              <HomeButtom
                onPress={() =>
                  navigation.navigate('PurchasedTicketScreen', {person})
                }
                iconName="ios-lock"
                title="My Ticket">
                <View style={{marginLeft: 'auto', marginRight: 'auto'}}>
            ...
            <View style={styles.menueContinerStyle}>
              ...
              <HomeButtom
                onPress={() => navigation.navigate('ComplaintScreen', {person})}
                iconName="ios-lock"
                title="Complain">
                <View style={{marginLeft: 'auto', marginRight: 'auto'}}>
                  <ComplaintIcon />
