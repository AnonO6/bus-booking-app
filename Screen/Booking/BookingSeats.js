    ...
    <View>
      ...
      <View
        ...
        <View
          ...
          <Text style={{marginTop: 'auto', marginBottom: 'auto', fontSize: 20}}>
            {Bus.Arrival}
          </Text>
          <Image
  ...
  return (
    <View
      ...
      <View style={{flexDirection: 'row', alignItems: 'center'}}>
        ...
        <Text style={{marginLeft: 10, color: 'black'}}>Student</Text>
      </View>
      <View style={{flexDirection: 'row', alignItems: 'center'}}>
        <View
          style={[
        ...
        <Text style={{marginLeft: 10, color: 'black'}}>Faculty</Text>
      </View>
      <View style={{flexDirection: 'row', alignItems: 'center'}}>
        <View
          style={[
        ...
        <Text style={{marginLeft: 10, color: 'black'}}>Booked</Text>
      </View>
    </View>
  );
}
...
function BookingSeats({navigation, route}) {
  ...
  function bookSeat() {
    ...
    setPromise(false);
    setError('');
    const CitiesNode = rootReference.child(
      'BusSchedule/' + selectedBus.FireBaseIndex + '/Pending',
    ); // Getting the Busschedule
    CitiesNode.once('value')
      ...
      .then(readCountTxn => {
        ...
        if (userIndex == -1) {
          NewBookedNode = rootReference.child(
            'BusSchedule/' + selectedBus.FireBaseIndex + '/Pending',
          );
