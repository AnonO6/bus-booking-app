...
function Destination(props) {
  return (
    <View>
      <View style={{display: props.modalVisible ? 'flex' : 'none'}}>
        <CityModal
          ...
          Selected={props.Selected}></CityModal>
      </View>
      <View
        style={{
          flexDirection: 'row',
  ...
  return (
    <View
      ...
      <View
        ...
        <Text style={{marginLeft: 10, fontSize: 15, color: 'black'}}>Date</Text>
      </View>
      <View>
        <Picker
