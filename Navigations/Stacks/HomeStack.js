  ...
  return (
    <Stack.Navigator
      ...
      <Stack.Screen
        ...
        initialParams={{person: props.person}}
      />
      <Stack.Screen
        name="BookingDestinationScreen"
        component={BookingDestinationScreen}
      />
      <Stack.Screen name="BookingBusesScreen" component={BookingBusesScreen} />
      <Stack.Screen
        name="BookingBusSeatsScreen"
        component={BookingBusSeatsScreen}
      />
      <Stack.Screen
      ...
      <Stack.Screen
        name="PurchasedTicketScreen"
        component={PurchasedTicketScreen}
      />
